# PITCH_STORY.md - Trusted AI for HR

## The Story of "RetainAI": AI That HR Can Trust
...
> "Here's what an HR director sees when they log in. Clean. Simple. No confusing charts."
...
> "Why? Click 'Explain.' Now we see it in plain language:
> - 'No salary adjustment in 18 months'
> - 'Team size decreased by 40%'
> - 'Last promotion was 32 months ago'
> - 'Workload increased significantly'"

**[ACTION: Show SHAP explanation panel with human-readable text]**
...
> "We're looking for partners who believe that the future of HR is transparent, fair, and human. Let's build that future together."

---

## 📋 QUICK REFERENCE: Section Timing

| Section | Time | Key Message |
|---------|------|-------------|
| Opening Hook | 1-2 min | The turnover problem is real |
| Conflict | 3-4 min | Traditional tools fail (black box, privacy, bias) |
| Solution | 3-4 min | Three pillars: Explainable + Privacy + Fairness |
| Demo | 3-4 min | Live prediction with human-readable explanations |
| Close | 1-2 min | Trust is everything |
